...
class Coinslash(commands.Cog):
    """The description for Coin goes here."""

    def __init__(self, client):
        self.client = client

    @slash_command(guild_ids=[879345472815386674], description="Full information about any coin including price information and social stats.")
    async def coin(self, ctx: commands.Context, *, 
                    ticker: Option(str, "Please enter the symbol of the coin", required=True),
                    char_limit: Option(int, "The number of lines to present for the description", required=False, default=600, choices=[1024, 900, 800, 700, 600, 500, 400, 300])
    ):
        ...
        embed.add_field(name="Description", value=desc[0:char_limit], inline=False)
        ...
        embed.set_footer(text="Flood Bot, The Best Crypto Discord Bot Ever!")
...
def setup(client):
    client.add_cog(Coinslash(client))
