...
class Defislash(commands.Cog):
    """The description for Defi goes here."""

    def __init__(self, client):
        self.client = client

    @slash_command(guild_ids=[879345472815386674], description="Full information about the DeFi market, Including volitility and dominance")
...
def setup(client):
    client.add_cog(Defislash(client))
